...
public record Syllabus(
     ...
     * 考点层 —— 差集运算的最小单位。
     *
     * <p>🔴 <b>没有 {@code children}</b>。第四层不是「暂时不做」,是结构上没有这个位置(01 §2.5)。
     *
