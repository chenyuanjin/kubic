...
import com.kaodian.server.api.dto.ArchivedNodesResponse;
import com.kaodian.server.api.dto.CreateGroupRequest;
import com.kaodian.server.api.dto.CreateNodeRequest;
import com.kaodian.server.api.dto.DeletedResponse;
import com.kaodian.server.api.dto.GroupEditResponse;
import com.kaodian.server.api.dto.GroupOrderRequest;
import com.kaodian.server.api.dto.MoveNodeRequest;
import com.kaodian.server.api.dto.MoveRecordsRequest;
import com.kaodian.server.api.dto.NodeEditResponse;
import com.kaodian.server.api.dto.NodeOrderRequest;
import com.kaodian.server.api.dto.RecordsMovedResponse;
import com.kaodian.server.api.dto.RenameRequest;
import com.kaodian.server.api.dto.SetFrequencyRequest;
import com.kaodian.server.api.dto.SummaryDto;
import com.kaodian.server.api.dto.SyllabusExportResponse;
import com.kaodian.server.api.dto.SyllabusGroupDto;
 ...
 * 目录页整块拷进来 —— 而 R-07 / docs/04 §1.2 要求<b>考点标签自行归纳、
 * 不沿用机构既有体系与措辞</b>。逐个新增很慢,慢正是要的效果。
 * <p>
 * 导出是有的({@link #export}),那是 01 §2.6 对用户的承诺:你的东西你随时能拿走。
