 ...
 * <h2>为什么这个端点必须存在</h2>
 *
 * docs/总路线图 §四 {@code R-32}:<b>无网时记不了 → 「懒得记」虚高 → 关卡 0 误判。</b>
 * 关卡 0 的输入是「每天主动记了几笔」这两个数,而地铁上、教室里、自习室角落
 ...
 * <h2>🔴 这里没有图片,也不会有</h2>
 *
 * docs/技术架构 §6.2 原文:「<b>只补传文本与元数据,图片逐条走 {@code /image}</b>——
