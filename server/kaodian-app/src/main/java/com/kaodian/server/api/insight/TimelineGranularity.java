...
/**
 * 时间线聚合的两种粒度 —— <b>按天 / 按周</b>(docs/10 §6.4「按天/周聚合触达」)。
 *
...
public enum TimelineGranularity {
     ...
     * 原样回显等于给「把一整段题干写进响应体和访问日志」开一条最不起眼的路(01 §2.2 不碰内容)。
     */
     ...
     * 两个决定各有理由:
     * <ul>
     *   <li><b>周一</b>:ISO-8601 的定义,而 docs/10 §六 已经把「时间一律 ISO-8601」
     ...
     *       这个产品能说的只有「有没有、几次、多久前」(01 §2.2),而「几次」必须是
     *       一个问两遍答案一样的数。</li>
     * </ul>
     */
