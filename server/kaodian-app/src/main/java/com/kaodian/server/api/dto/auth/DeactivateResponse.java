 ...
 *
 * docs/technical/INDEX.md §6.1:<b>「{@code DELETE /account} 的响应里必须带导出入口提示」</b>({@code 1.3.1.3.3})。
 * 决策记录 §2.6 的开放性承诺是完整导出;一个删完才想起来「我的记录呢」的用户,
 * 是这条承诺最直接的反例。
 *
 ...
 * 采用哪个由 {@code L-A5} 的律师稿定(docs/technical/INDEX.md §6.1)。
 * <p>
