/**
 * `1.1.3.3` —— docs/execution/INDEX.md 原文:「验证:改系统时间实测删除生效」。
 *
 * <h2>这个文件存在的理由:那条验证不该只有人能做</h2>
 *
 * 「改系统时间」是一条只能手工做、做完没有留痕、下次改代码不会自动重做的验证。
 * 而 `1.1.3` 在 docs/execution/INDEX.md 上标着「<b>第一天不定就改不回来</b>」——
 ...
 * (docs/data/基础数据-抓取范围与渠道.md §B.10 与 `R-46`:这个仓库的依赖清洗是人工 grep,
