...
**没有一条路线要求读完全部 28 份。** 全读一遍是 11,000 行（`wc -l docs/*.md`），等于什么都没读。

| 你要干什么 | 路线 | 行数 |
|---|---|---|
| **搞懂这是什么** | [`01` 现状与决策](01-项目现状与决策记录.md) → [`22` 产品模块脑图](22-产品模块脑图.md) → [`20` 模块地图](20-产品模块地图与产品逻辑.md) → [`04` 实施路径](04-实施路径.md) | ~940 |
| **搞懂某个模块怎么运转** | [`22` 脑图](22-产品模块脑图.md) 找到它挂在哪一组 → 该组的展开文档 [`23`](23-模块A-骨架层.md)–[`27`](27-模块E-出口层.md)。**F/G/H/X 没有展开文档**，去 `20` §九 拿真源 | ~180/份 |
...
| [`20` 产品模块地图与产品逻辑](20-产品模块地图与产品逻辑.md) + [`22` 脑图](22-产品模块脑图.md) | 产品由哪些模块组成、每个模块归哪个关卡。脑图在 `22`（markmap 格式，可折叠；不装工具打开是可读大纲） | 讨论功能之前 |
...
**模块展开文档 `23`–`27`**（A 骨架层 / B 采集层 / C 打标层 / D 差集层 / E 出口层，共 ~820 行）也在这一档：
**按模块读，不按号读** —— 你在改哪个模块就只读那一份，每份都自带「状态 + 转移条件 + 失败落点 + 交互示意 + 边界」。
其中 [`24` B 采集层](24-模块B-采集层.md) 是唯一整个服务**关卡 0** 的一份，也就是当前唯一有效的工作面。
...
|---|---|---|
| **整体** | [`01`](01-项目现状与决策记录.md) 现状与决策 · [`20`](20-产品模块地图与产品逻辑.md) 模块地图 · [`22`](22-产品模块脑图.md) 脑图 | [`10`](10-技术架构与接口契约.md) 架构与接口契约 |
| **展开** | [`23`](23-模块A-骨架层.md)–[`27`](27-模块E-出口层.md) 模块 A–E 展开 · [`16`](16-产品路线图与用户共创.md) 对外路线图 · [`11`](11-商业化与额度设计.md) 商业化与额度 | [`13`](13-后端系统设计与组件接入.md) 后端详设 · [`19`](19-多端选型与端矩阵.md) 端矩阵 · [`15`](15-Agent框架与能力边界.md) Agent 框架 |
...
| 关卡 | 状态 | 服务它的文档 |
|---|---|---|
| **关卡 0** 采集摩擦自检 | **当前 · 未过** | [`04`](04-实施路径.md) §关卡0 · [`05`](05-执行清单.md) P0 · [`06`](06-阶段0至关卡2详细排期.md) §三 · [`24` B 采集层](24-模块B-采集层.md) |
| 关卡 1 骨架与单人闭环 | 未开始 | [`05`](05-执行清单.md) P1 · [`06`](06-阶段0至关卡2详细排期.md) §四 · [`10`](10-技术架构与接口契约.md) · [`13`](13-后端系统设计与组件接入.md) · [`23`](23-模块A-骨架层.md) [`25`](25-模块C-打标层.md) [`26`](26-模块D-差集层.md) [`27`](27-模块E-出口层.md) |
...
| **不服务任何关卡** | — | `02` `03` `07` `09` `12` `14` `15` `17` `18` `19` `21`（+ `00` `20` `22` 本文 = 元文档） |
...
新增一份模块文档要改三处：`00` §2.1 加行 + §2.3 领号、`20` §三 加指针、本文 §二/§四/§五。
