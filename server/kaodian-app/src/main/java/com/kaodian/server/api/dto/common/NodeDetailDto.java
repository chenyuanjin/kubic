 ...
 * 是从哪几个来源碰的。<b>它不会告诉你这个考点怎么做题</b> —— 那是教研,决策记录 §2.2 划在边界外,
 * 而这条边界被描述为其他所有优势的来源。
 *
 * <h2>{@code sources} 里只有来源的名字</h2>
 *
 * 「粉笔 · 资料分析系统班 L12」是一个字符串,不是那节课的任何内容。
 * 决策记录 §2.2 不碰内容:机构的课程内容一概不存,只记来源名与时间戳。
 *
 * <h2>关于「四统计字段」</h2>
 *
