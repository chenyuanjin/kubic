 ...
 * docs/技术架构 §6.5 的四道锁是有意冗余的,同一条思路:<b>一道锁失效不该导致整条线失守</b>。
...
public class ApiCorsConfig implements WebMvcConfigurer {
    ...
    public void addCorsMappings(CorsRegistry registry) {
        ...
        registry.addMapping("/api/account")                 // 注销账号(docs/技术架构 §6.1)
        ...
        // 删一条记录(docs/技术架构 §6.2)。范围刻意写成 /api/records/* 而不是 /api/records/** ——
        ...
        // 取消「我已掌握」(docs/技术架构 §6.4 的 DELETE /assertions)。
        ...
        registry.addMapping("/api/**")
                ...
                .allowedHeaders("Content-Type", "Authorization")
                // 现在没有 Cookie 会话(令牌方案见 docs/技术架构 §7.4),不需要带凭据的跨域。
