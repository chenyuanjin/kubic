...
/**
 * 「我已掌握」/ 取消 —— docs/10 §6.4 那张表的最后一行。
 *
 * <h2>🔴 这两个端点<b>动不了覆盖率</b>,这是它们最重要的性质</h2>
 *
 * 01 §5.2 用一句话给这个按钮定了性:<b>「『我已掌握』按钮是补丁不是解法。」</b>
 ...
 * (01 §2.2 的能力边界只有「有没有、几次、多久前」,而声明不是其中任何一样)。
 * <p>
 ...
 * 归档那一侧有一条单独的风险记录({@code docs/08} §四 {@code R-49}:归档可无声刷高覆盖率);
...
public class AssertionController {
    ...
    /**
     * 我已掌握。<b>body 只接受 {@code nodeCode}</b>(docs/10 §6.4)。
     *
