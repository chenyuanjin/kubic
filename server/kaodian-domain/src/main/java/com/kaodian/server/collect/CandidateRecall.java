...
/**
 * 打标管线的<b>第 ① 段:候选召回</b>(docs/后端详设 §1.3)。
 *
 * <h2>🔴 这一段不是省钱技巧,是闭集的前提</h2>
 *
 * docs/后端详设 §1.3 ① 的原话:「关键词/规则,缩到 5–10 个。<b>便宜手段先做。
 ...
 *       docs/后端详设 §1.3 的原话:「召回不出来就不调模型。<b>调了也只能瞎猜</b>」</li>
 * </ol>
 ...
 * 没有转写文本、没有笔记摘要、没有原图 —— 决策记录 §2.2「不碰内容」/ docs/技术架构 §5.1
 ...
 * 要让它变强,得先有一个「能装下一句话摘要」的字段,而那是 docs/技术架构 §5.2 的
...
public class CandidateRecall {
    ...
    /**
     * 候选上限 —— docs/后端详设 §1.3 的「缩到 5–10 个」取上界。
     *
