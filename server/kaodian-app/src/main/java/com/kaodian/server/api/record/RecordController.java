...
/**
 * 「记一笔」及其读侧 —— docs/technical/INDEX.md §6.2 采集那张表。
 *
 ...
 * 永不消耗额度、永不受识别故障影响(docs/product/商业化与额度设计.md §二「额度用尽 ≠ 记不了」)。
...
public class RecordController {
     ...
     * <p>
     * 两种情况都<b>不是错误</b>:重复提交不报错,是 docs/technical/INDEX.md §6.2「{@code client_token} 幂等」
     * 的字面要求,也是离线队列敢重发的前提。
     */
    @PostMapping
    ...
    /**
     * 离线队列补传 —— docs/execution/INDEX.md {@code R-32} 的防线落到接口上的那一段。
     *
     ...
     *
     * docs/technical/INDEX.md §6.2 的原文是「<b>级联删标签</b>,触发覆盖层重算」。
