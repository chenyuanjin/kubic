...
/**
 * 一次补标的答复 —— docs/technical/INDEX.md §6.3:「响应是 {@code nodeId + confidence} 或 {@code NO_MATCH}」。
 *
 * <h2>两个端点共用这一个形状</h2>
 *
 ...
 * docs/technical/后端系统设计与组件接入.md §1.5 那句「降级方向是『少功能』,不是『少记录』」落到状态码上就是这条区别 ——
 ...
 *                       (docs/technical/后端系统设计与组件接入.md §1.3:「召回不出来就不调模型,调了也只能瞎猜」)
