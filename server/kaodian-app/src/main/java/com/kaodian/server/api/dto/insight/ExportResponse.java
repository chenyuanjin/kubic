...
/**
 * 全量导出的<b>唯一那份数据</b> —— md / csv / json 三种写法都从它渲染(docs/technical/INDEX.md §6.5)。
 *
 ...
 *                      docs/technical/后端系统设计与组件接入.md {@code R-49}:「归档可以无声刷高覆盖率」,
 *                      而三条对策之一就是「导出带完整归档清单」。少了这一段,
 *                      导出就成了那句无声的同谋
 * @param assertedNodes 声明「我已掌握」的考点 —— docs/technical/INDEX.md §5.2 {@code user_assertion}
...
public record ExportResponse(
     ...
     * 反过来依赖 {@code api} ——「包之间只通过接口调用」(docs/technical/INDEX.md §2.2),
