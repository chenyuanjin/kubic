 ...
 * 上游的 {@link Touch} 结构上就没有这些字段(决策记录 §2.2 不碰内容),这里也不会凭空长出来。
 * <b>语音的转写文本用完即弃,原图送识别一次即删</b>(决策记录 §2.3 / docs/data/识别链路选型.md 坑二),
 * 它们从来没有进过任何一条记录。
 * <p>
 ...
 *
 * 它们是<b>用户自己敲进来的两个整数</b>,属于「几次」,不属于「对不对」(决策记录 §2.2)。
